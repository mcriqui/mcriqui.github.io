...
<div class="post-content col three">
	<h1 class="project-description-title">Exploring the Problem Space</h1>
...
<div class="post-content col three">
	<h1 class="project-description-title">Down the Wrong Path</h1>
	<p>We generated many ideas and finally decided on an iPad application that would facilitate role playing activities so a high functioning autistic adult could practice their social skills and record the activity to reflect and learn from. This design, however, relied heavily on a facilitator or therapist. We wanted to create something that wasn’t reliant on a clinical setting because role playing activities within this environment already exist.</p>
	<div class="">
		<img class="col one" src="{{ site.baseurl }}/img/ipad1.jpg"/>
		<img class="col one" src="{{ site.baseurl }}/img/ipad2.jpg"/>
		<img class="col one" src="{{ site.baseurl }}/img/ipad3.jpg"/>
	</div>
